...
export default function ColorPicker() {
  ...
  const copyToClipboard = (): void => {
    ...
    alert(" Successfully!"); // Alert the user that the color was copied
  };

  // JSX return statement rendering the color picker UI
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-slate-400  dark:bg-gray-900">
